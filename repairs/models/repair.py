...
class Repair(models.Model):
    ...
    places_to_work = models.ForeignKey(
        'repairs.PlacesWork',
        verbose_name='Место для ремонта', on_delete=models.PROTECT,
        related_name='place_repairs', null=True, blank=True
    )
    locomotove = models.ForeignKey(
        'repairs.Locomotive',
        verbose_name='Локомотив', on_delete=models.PROTECT,
        related_name='locomotive_repairs', null=True, blank=True
    )
    type_repair = models.ForeignKey(
        'repairs.TypesRepair',
        verbose_name='Тип ремонта', on_delete=models.PROTECT,
        related_name='type_repairs', null=True, blank=True
    )
    works = models.ManyToManyField(
        to='repairs.Work',
        verbose_name='Работы', related_name='work_repairs'
    )
    parts = models.ManyToManyField(
        to='repairs.Parts',
        verbose_name='Запчасти', related_name='part_repairs'
    )
